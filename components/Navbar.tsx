...
export const Navbar: React.FC<NavbarProps> = ({ scrolled }) => {
  ...
  return (
    ...
    >
      ...
      {mobileMenuOpen && (
        <div className="md:hidden absolute top-full left-0 w-full bg-black/95 border-b border-white/10 backdrop-blur-xl p-6 flex flex-col gap-6">
          ...
          <a href="https://athenea-nine.vercel.app/" target="_blank" rel="noopener noreferrer" className="bg-athena-purple text-white px-6 py-3 rounded-lg w-full font-bold text-center block">
            Download Beta
          </a>
        </div>
      )}
